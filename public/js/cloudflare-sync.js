(() => {
  ...
  window.TPCloud={checkCloud,session,login,logout,pullData,pullStateInfo,pushData,listMedia,listReviews,saveEntity,createEntity,deleteEntity,patchSettings,pullMessages,markMessageRead,clearMessages,addMessage,addReview,upload,uploadImage,uploadD1Photo,deleteMedia,lastError:()=>lastError,getHealth:()=>health};
})();
